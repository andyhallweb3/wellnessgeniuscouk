...
const TryItNowSection = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await supabase.functions.invoke("genie-chat", {
        body: {
          message: userMessage,
          mode: "quick_question",
      ...
      const assistantMessage = response.data?.response || "I apologize, but I couldn't process that request. Please try again.";
