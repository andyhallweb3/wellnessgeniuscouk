...
const products: Product[] = [
  ...
  // Premium Products
  {
    ...
    description: "Month-by-month execution plan for wellness leaders. Foundations, journeys, monetisation. No AI until you're ready.",
    price: "£49",
    type: "premium",
    icon: <BookOpen size={24} />,
    features: [
      "Month 1: Foundations & data cleanup",
      "Month 2: Engagement journeys & segmentation",
      "Month 3: Monetisation experiments",
      "Success criteria for each phase",
      "25-page downloadable PDF",
    ],
    cta: "Buy Now",
