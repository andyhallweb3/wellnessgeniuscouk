...
- For AI/technology questions → suggest the AI Readiness Assessment: https://www.wellnessgenius.co.uk/ai-readiness
...
When relevant, remind them of the FREE AI Readiness Assessment at https://www.wellnessgenius.co.uk/ai-readiness - this helps personalise your future responses.
...
When relevant, mention that the FREE AI Readiness Assessment at https://www.wellnessgenius.co.uk/ai-readiness can help personalise future advice.`;
...
async function getLatestNews(supabase: SupabaseClientAny): Promise<string> {
  ...
  const footer = `\n\n━━━━━━━━━━━━━━━━━━━━━
📊 AI Readiness: https://www.wellnessgenius.co.uk/ai-readiness
🤖 AI Advisor: https://www.wellnessgenius.co.uk/genie`;
...
${isSubscribed ? '🌟 You have an active subscription - all premium commands unlocked!' : '⚠️ No active subscription found. Subscribe at https://www.wellnessgenius.co.uk/genie for premium commands.'}`;
      } else {
...
1. Go to https://www.wellnessgenius.co.uk/hub
...
👉 https://www.wellnessgenius.co.uk/auth to sign up!`;
      }
    }
...
To unlock:
1. Subscribe at https://www.wellnessgenius.co.uk/genie
...
💬 Tag @Wellnessgenius_bot in groups`;
      ...
      if (!isSubscribed) {
        if (telegramUser.daily_messages_used >= FREE_DAILY_LIMIT) {
          ...
          if (!anthropicKey) {
            responseText = "I'm currently in limited mode. Please try the commands (/news, /readiness, /tryai) or visit https://www.wellnessgenius.co.uk for full AI chat!";
          } else {
            const anthropic = new Anthropic({ apiKey: anthropicKey });
        ...
        if (!anthropicKey) {
          responseText = "I'm currently in limited mode. Please try again later or visit https://www.wellnessgenius.co.uk/genie";
        } else {
          const anthropic = new Anthropic({ apiKey: anthropicKey });
          const cleanedMessage = text.replace(/@wellnessgenius_bot/gi, '').trim();
